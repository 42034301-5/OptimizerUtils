...
int main()
{
    ...
    for (int i = 0; i < code.size(); i++)
    {
        ...
        else if (code[i].op == "JGT" || code[i].op == "JEQ" || code[i].op == "JLE")
        {
    ...
    while (!intro.empty())
    {
        ...
        for (; j < t; j++)
        {
            if (code[j].op == "JGT" || code[j].op == "JEQ" || code[j].op == "JLE" || code[j].op == "JMP" || code[j].op == "HALT")
            {
                // cout << code[j];
    ...
    for (auto &b : blocks)
    {
        ...
        else
        {
            ...
            if (tempop == "JGT" || tempop == "JLE" || tempop == "JEQ")
            {
                int j = 0;
                for (; j < blocks.size(); j++)
                {
        ...
        {
            string tempop = l.op;
            if (tempop != "JMP" && tempop != "JEQ" && tempop != "JGT" && tempop != "JLE" && tempop != "LABEL")
            {
            ...
            else if (tempop == "JGT" || tempop == "JLE" || tempop == "JEQ")
            {
                if (regex_match(l.a1, variable_reg))
                    vars.insert(l.a1);
                if (regex_match(l.a2, variable_reg))
        ...
        for (int i = 0; i < b.lines.size(); i++)
        {
            ...
            string tempop = l.op;
            if (tempop != "JMP" && tempop != "JEQ" && tempop != "JGT" && tempop != "JLE" && tempop != "LABEL" && tempop != "WRITE")
            {
        ...
        for (int i = 0; i < b.lines.size(); i++)
        {
            quad_exp l = b.lines[i];
            string tempop = l.op;
            if (tempop != "JMP" && tempop != "READ" && tempop != "LABEL" && tempop != "JEQ" && tempop != "JGT" && tempop != "JLE")
            {
                if (regex_match(l.a2, variable_reg))
                {
                    bool flag = true;
